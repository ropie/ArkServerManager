...
export default function Record() {
  ...
  const completedBosses = records.bosses 
  const bossIndex = records.implantid
  console.log(`The completed boss array ${records.bosses}`)
  const bosses = completedBosses?.map((boss, i) => ( <li key={i}>{boss}</li>))
