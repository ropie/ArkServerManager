  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await fetch(
        `https://arkservermanagerbackend.onrender.com:5050/${params.id.toString()}`
      );
      if (!response.ok) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (isNew) {
        ...
        response = await fetch(`https://arkservermanagerbackend.onrender.com:5050/record`, {
          method: "POST",
          headers: {
        ...
        response = await fetch(`https://arkservermanagerbackend.onrender.com:5050/record/${params.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
