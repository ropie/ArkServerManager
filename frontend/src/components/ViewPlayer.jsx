  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (isNew) {
        ...
        response = await fetch(`https://arkservermanagerbackend.onrender.com/record`, {
          method: "POST",
          headers: {
        ...
        response = await fetch(`https://arkservermanagerbackend.onrender.com/record/${params.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
